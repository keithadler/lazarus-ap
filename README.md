...
the five-computer vote, the crew keyboard and CRT, the flight math, the
history, and a defect report. One self-contained page; serves from
...
| | |
|---|---|
| **The machine** | AP-101S CPU (138 instructions), hexadecimal floating point, interrupts, storage protection, the IOP with its Master Sequence Controller and 24 Bus Control Elements |
...
| **NASA flight code** | 202 of 205 recovered runtime routines assemble; **30 execute**, including the complete attitude toolkit |
...
Thirty genuine routines, each assembled by the real flight assembler and
checked against modern mathematics — full table in
[roms/nasa/CENSUS.md](roms/nasa/CENSUS.md):
